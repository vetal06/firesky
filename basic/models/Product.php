...
class Product extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['name', 'fk_category_id'], 'required'],
            [['fk_category_id'], 'integer'],
            [['is_available'], 'boolean'],
            [['created_at', 'update_at'], 'safe'],
            [['description', 'images'], 'string'],
            ['characteristics', 'each', 'rule' => ['string']],
            [['name', 'alias', 'youtube_url'], 'string', 'max' => 255],
    ...
    public function beforeSave($insert)
    {
        if (is_array($this->characteristics)) {
            $this->characteristics = Json::encode( $this->characteristics);
        }
   ...
   */
    ...
    {
        $characteristicsValues = $this->characteristics;
