    ...
    public function getLangUrl()
    {
        if ($this->_lang_url === null) {
            ...
            if (isset(\Yii::$app->params['languages']['list'][$lang_url])) {
                $currentLang = $lang_url;
            } else {
                $currentLang = \Yii::$app->params['languages']['default'];
            }

            if( $lang_url !== null && $lang_url === $currentLang &&
                strpos($this->_lang_url, $currentLang) === 1 )
            {
                $this->_lang_url = substr($this->_lang_url, strlen($currentLang)+1);
            }
