    ...
    t.mlsCart = {
        loadSummaryJson: function (a, e) {
            var o = a.attr("data-cart-summary--href"), r = a.closest("[data-cart-summary]"),
                d = r.attr("data-cart-summary--url"), n = r.attr("data-cart-summary--tpl"),
                i = t("[data-cart-summary]"), s = t('[data-cart-summary="modal"]'), l = t('[data-cart-summary="page"]');
            t.ajax({
                url: o,
                ...
                dataType: "json",
                beforeSend: function () {
                    t.mlsAjax.preloaderShow({type: "frame", frame: i})
                },
                success: function () {
                    l.size() > 0 && s.size() > 0 && (i = s, t.ajax({
                        url: d, success: function (a) {
                            t.mlsAjax.loadResponseFrame(a, l)
                        }
                    })), t.ajax({
                        url: d, data: {template: n}, success: function (a) {
                            e.loadFrame && t.mlsAjax.loadResponseFrame(a, i), e.transferData && t.mlsAjax.transferData(a), e.toggleAddToCartButton && t.mshProduct.editCartButtons(e.variantId, 0), e.toggleKitButton && e.kitList.toggleClass("hidden")
                        }
                    })
                }
            })
        ...
        zoomImage: function () {
            ...
            a = a || 0, e = e || t("[data-magnific-galley]"), e.each(function () {
                var e, o, r = t(this), d = r.find("[data-magnific-galley-main]"),
                    n = r.find("[data-magnific-galley-thumb]"), i = [];
                n.size() > 0 && (n.each(function () {
                    var a = {src: t(this).attr("href")};
                    i.push(a)
                }), e = i.splice(0, a), o = i.concat(e)), d.magnificPopup({
                    items: o,
                    type: "image",
...
var mlsMegamenu = function () {
    var t = function (t) {
        ...
        var o = document.querySelectorAll("[data-megamenu-item]");
        Array.prototype.forEach.call(o, function (o) {
            var r = o.querySelector("[data-megamenu-wrap]"), d = o.querySelector("[data-megamenu-coll]"),
                n = o.querySelectorAll("[data-megamenu-coll-item]"), i = t(n);
            if (!(i <= 1)) {
                var s = a(d, i);
                e(n, s), s.forEach(function (t) {
                    r.appendChild(t)
                })
            }
        })
...
!function (t) {
    t.mshProduct = {
        loadCartButton: function (t) {
            var a = t.closest("[data-product-scope]"), e = t.attr("data-product-variant--id"),
                ...
                d = a.find("[data-product-button--add]"), n = a.find("[data-product-button--quantity]"),
                i = a.find("[data-product-button--view]");
            o.attr("data-product-button--variant", e), r ? (d.add(n).addClass("hidden"), i.removeClass("hidden")) : (d.add(n).removeClass("hidden"), i.addClass("hidden"))
    ...
    var a = $(this), e = a.closest("[data-comments]"), o = a.attr("data-comments-form"),
        ...
        n = r + " [data-comments-error-frame]", i = r + " [data-comments-error-list]";
    $.ajax({
        ...
        success: function (t) {
            "error" == t.answer ? (e.find(d).addClass("hidden"), e.find(i).html(t.validation_errors), e.find(n).removeClass("hidden"), e.find(r + " [data-captcha-img]").html(t.cap_image)) : $.ajax({
                url: a.attr("data-comments-form-list-url"),
                method: "post",
                dataType: "json",
                success: function (t) {
                    e.html(t.comments), e.find(n).addClass("hidden"), e.find(d).removeClass("hidden")
                }
            })
        }
    })
    ...
    if (null != document.querySelector("[data-megamenu-container]")) {
        var t = document.querySelector("[data-megamenu-container]"), a = t.querySelectorAll("[data-megamenu-wrap]");
        mlsMegamenu.renderCols(), mlsMegamenu.equalHeight(t, a)
    }
    ...
    $.ajax({
        url: r, data: a.serialize(), type: a.attr("method"), dataType: "json", beforeSend: function () {
            ...
            $.mlsModal({src: d, data: {template: n}, transferData: !0}), $.mshProduct.editCartButtons(o, 1)
        }
    })
    ...
    function t() {
        o.toggleClass("hidden"), a.toggleClass(r), e.toggleClass(d), n.toggleClass("hidden")
    }

    var a = $("[ data-page-pushy-mobile]"), e = $("[ data-page-pushy-container]"), o = $("[data-page-pushy-overlay]"),
        r = "page__mobile--js-open", d = "page__body--js-pushed", n = $("[data-page-mobile-btn]");
    n.click(function () {
        t()
    }), o.click(function () {
        t()
    ...
    var a, e, o, r = t('[data-autocomplete="header-search"]'), d = r.find("[data-autocomplete-frame]"),
        n = r.find("[data-autocomplete-product]").size(), i = r.find("[data-autocomplete-noitems]"), s = function (a) {
            ...
            for (var d = n; d >= e; d--)r.find('[data-autocomplete-product="' + d + '"]').addClass("hidden");
            return d
        }, l = function (a, e) {
            ...
            t.ajax({
                ...
                success: function (t) {
                    a = s(t), a < 0 ? i.removeClass("hidden") : i.addClass("hidden"), d.removeClass("hidden")
                }
            })
        };
    ...
    var t = $("#catalog-form"), a = $("[data-filter]"), e = "data-filter-price-min", o = "data-filter-price-max",
        ...
        n = parseFloat(a.find("[" + o + "]").attr(o)), i = parseFloat(a.find("[" + e + "]").attr("value")),
        s = parseFloat(a.find("[" + o + "]").attr("value"));
    $("[" + r + "]").slider({
        min: d, max: n, values: [i, s], range: !0, slide: function (t, r) {
            var d = r.values[0], n = r.values[1];
            a.find("[" + e + "]").val(d), a.find("[" + o + "]").val(n)
        }, change: function () {
    ...
    var a, e = $(this), o = e.closest("[data-product-photo-scope]"), r = "[data-product-photo-thumb]",
        d = "[data-product-photo-thumb-active]", n = e.closest("[data-magnific-galley]"), i = e.attr("href"),
        s = o.find("[data-product-photo-link]"), l = o.find("[data-product-photo]"), c = o.find("[data-zoom-image]");
    o.find(r).removeAttr("data-product-photo-thumb-active"), e.attr("data-product-photo-thumb-active", ""), s.attr("href", i), l.attr("src", i), c.attr("data-zoom-image", i), $.mlsMedia.zoomImage(), a = o.find(r).index(o.find(d)), $.mlsMedia.magnificGalley(a, n)
}), function () {
